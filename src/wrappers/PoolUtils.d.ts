...
interface PoolUtilsInterface extends ethers.utils.Interface {
  functions: {
    'addEthCollateralInMarginCall(address,address)': FunctionFragment;
    'bin()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'bin', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'bin', data: BytesLike): Result;
...
export class PoolUtils extends Contract {
  ...
  functions: {
    ...
    bin(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    bin(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    bin(overrides?: CallOverrides): Promise<PopulatedTransaction>;
