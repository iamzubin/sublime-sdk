...
export class PoolToken extends Contract {
  ...
  callStatic: {
    ...
    'initialize(string,string,address)'(name: string, symbol: string, _pool: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    transfer(_recipient: string, _amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
