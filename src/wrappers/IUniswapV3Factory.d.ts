...
export class IUniswapV3Factory extends Contract {
  ...
  functions: {
    ...
    'setOwner(address)'(_owner: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  };
  ...
  'getPool(address,address,uint24)'(tokenA: string, tokenB: string, fee: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  callStatic: {
    ...
    'createPool(address,address,uint24)'(tokenA: string, tokenB: string, fee: BigNumberish, overrides?: CallOverrides): Promise<string>;

    enableFeeAmount(fee: BigNumberish, tickSpacing: BigNumberish, overrides?: CallOverrides): Promise<void>;

    'enableFeeAmount(uint24,int24)'(fee: BigNumberish, tickSpacing: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    'feeAmountTickSpacing(uint24)'(fee: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    getPool(tokenA: string, tokenB: string, fee: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    'getPool(address,address,uint24)'(tokenA: string, tokenB: string, fee: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    'setOwner(address)'(_owner: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    'feeAmountTickSpacing(uint24)'(fee: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    'setOwner(address)'(_owner: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
  };
}
