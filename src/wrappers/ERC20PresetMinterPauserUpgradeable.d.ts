...
export class ERC20PresetMinterPauserUpgradeable extends Contract {
  ...
  functions: {
    ...
    initialize(name: string, symbol: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    initialize(name: string, symbol: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    initialize(name: string, symbol: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
