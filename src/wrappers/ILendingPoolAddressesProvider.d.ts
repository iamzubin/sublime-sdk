...
export class ILendingPoolAddressesProvider extends Contract {
  ...
  functions: {
    ...
    'getAddress(bytes32)'(id: BytesLike, overrides?: CallOverrides): Promise<[string]>;
    ...
    setEmergencyAdmin(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    'setEmergencyAdmin(address)'(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    setLendingPoolImpl(pool: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    'setLendingPoolImpl(address)'(pool: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    setMarketId(marketId: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    'setMarketId(string)'(marketId: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    setPoolAdmin(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    'setPoolAdmin(address)'(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    setPriceOracle(priceOracle: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  setAddress(id: BytesLike, newAddress: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  setAddressAsProxy(id: BytesLike, impl: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  'setPriceOracle(address)'(priceOracle: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    'setAddress(bytes32,address)'(id: BytesLike, newAddress: string, overrides?: CallOverrides): Promise<void>;

    setAddressAsProxy(id: BytesLike, impl: string, overrides?: CallOverrides): Promise<void>;

    'setAddressAsProxy(bytes32,address)'(id: BytesLike, impl: string, overrides?: CallOverrides): Promise<void>;

    setEmergencyAdmin(admin: string, overrides?: CallOverrides): Promise<void>;

    'setEmergencyAdmin(address)'(admin: string, overrides?: CallOverrides): Promise<void>;

    setLendingPoolCollateralManager(manager: string, overrides?: CallOverrides): Promise<void>;

    'setLendingPoolCollateralManager(address)'(manager: string, overrides?: CallOverrides): Promise<void>;

    setLendingPoolConfiguratorImpl(configurator: string, overrides?: CallOverrides): Promise<void>;

    'setLendingPoolConfiguratorImpl(address)'(configurator: string, overrides?: CallOverrides): Promise<void>;
    ...
    'setLendingRateOracle(address)'(lendingRateOracle: string, overrides?: CallOverrides): Promise<void>;

    setMarketId(marketId: string, overrides?: CallOverrides): Promise<void>;

    'setMarketId(string)'(marketId: string, overrides?: CallOverrides): Promise<void>;

    setPoolAdmin(admin: string, overrides?: CallOverrides): Promise<void>;

    'setPoolAdmin(address)'(admin: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    AddressSet(
      ...
      hasProxy: null
    ): TypedEventFilter<[string, string, boolean], { id: string; newAddress: string; hasProxy: boolean }>;

    ConfigurationAdminUpdated(newAddress: string | null): TypedEventFilter<[string], { newAddress: string }>;

    EmergencyAdminUpdated(newAddress: string | null): TypedEventFilter<[string], { newAddress: string }>;

    LendingPoolCollateralManagerUpdated(newAddress: string | null): TypedEventFilter<[string], { newAddress: string }>;

    LendingPoolConfiguratorUpdated(newAddress: string | null): TypedEventFilter<[string], { newAddress: string }>;

    LendingPoolUpdated(newAddress: string | null): TypedEventFilter<[string], { newAddress: string }>;

    LendingRateOracleUpdated(newAddress: string | null): TypedEventFilter<[string], { newAddress: string }>;

    MarketIdSet(newMarketId: null): TypedEventFilter<[string], { newMarketId: string }>;

    PriceOracleUpdated(newAddress: string | null): TypedEventFilter<[string], { newAddress: string }>;

    ProxyCreated(id: null, newAddress: string | null): TypedEventFilter<[string, string], { id: string; newAddress: string }>;
  };

  estimateGas: {
    getAddress(id: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;

    'getAddress(bytes32)'(id: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setAddress(id: BytesLike, newAddress: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    setAddressAsProxy(id: BytesLike, impl: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    setEmergencyAdmin(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    'setEmergencyAdmin(address)'(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    setLendingPoolCollateralManager(manager: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    setLendingPoolConfiguratorImpl(configurator: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    setLendingPoolImpl(pool: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    'setLendingPoolImpl(address)'(pool: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    setLendingRateOracle(lendingRateOracle: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    setMarketId(marketId: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    'setMarketId(string)'(marketId: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    setPoolAdmin(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    'setPoolAdmin(address)'(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    setPriceOracle(priceOracle: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    'setPriceOracle(address)'(priceOracle: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  };

  populateTransaction: {
    getAddress(id: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    'getAddress(bytes32)'(id: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    setEmergencyAdmin(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    'setEmergencyAdmin(address)'(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    setLendingPoolImpl(pool: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    'setLendingPoolImpl(address)'(pool: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    setMarketId(marketId: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    'setMarketId(string)'(marketId: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    setPoolAdmin(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    'setPoolAdmin(address)'(admin: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    setPriceOracle(priceOracle: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
