...
export class IyVault extends Contract {
  ...
  functions: {
    ...
    min(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    'min()'(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    setMin(arg0: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    'setMin(uint256)'(arg0: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    'setMin(uint256)'(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    min(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    'min()'(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    setMin(arg0: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    'setMin(uint256)'(arg0: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    min(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    'min()'(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    setMin(arg0: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    'setMin(uint256)'(arg0: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
