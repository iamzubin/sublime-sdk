...
subgraph.getSavingsAccountTokenDetail('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
...
subgraph.getAllLendersOfPool('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
...
connector
  ...
  .requestCreditLineToBorrower({
    ...
    collateralAsset: '0x482dc9bb08111cb875109b075a40881e48ae02cd', // this is USDC
...
connector.CreditLinesApi().depositCollateral("0x0175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9", "12.343", false).then(console.log)
connector.CreditLinesApi().borrowFromCreditLine("0x0175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9", "12.343").then(console.log);
connector.CreditLinesApi().repayCreditLine("0x0175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9", "12.343", false).then(console.log);
connector.CreditLinesApi().closeCreditLine("0x0175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9").then(console.log);
connector.CreditLinesApi().liquidateCreditLine("0x0175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9").then(console.log);
...
connector.ExtensionApi().requestExtenstion('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.ExtensionApi().voteOnExtension('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
...
connector.PoolApi().depositCollateral('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', '0.0334', false).then(console.log);
connector.PoolApi().interestTillNow('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.PoolApi().interestPerPeriod('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', '10000000000').then(console.log);
connector.PoolApi().interestPerSecond('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', '10000000000').then(console.log);

connector.PoolApi().getCurrentCollateralRatio('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.PoolApi().liquidatePool('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', false, false, false).then(console.log);

connector
  .PoolApi()
  .liquidateLender('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', '0xab2af84a9db35f92dfb5b0607bd91226f5e97469', false, false, false)
  .then(console.log);

connector.PoolApi().calculateCurrentPeriod('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);

connector
  .PoolApi()
  .getMarginCallEndTime('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', '0xab2af84a9db35f92dfb5b0607bd91226f5e97469')
  .then(console.log);

connector.PoolApi().getLoanStatus('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);

connector
  .PoolApi()
  .getBalanceDetails('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', '0xab2af84a9db35f92dfb5b0607bd91226f5e97469')
  .then(console.log);

connector.PoolApi().getTotalSupply('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);

connector.PoolApi().getPoolInfo('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);

connector.RepaymentApi().getInterestPerSecond('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getInstalmentsCompleted('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getInterestDueTillInstalmentDeadline('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getNextInstalmentDeadline('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getCurrentInstalmentInterval('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getCurrentLoanInterval('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().isGracePenaltyApplicable('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().didBorrowerDefault('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getInterestLeft('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getInterestOverdue('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getTotalRepaidAmount('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().getGracePeriodFraction('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
connector.RepaymentApi().repayAmount('0xED455becbCeA559763C2a84b6C69Ff297C303A2b', '12.43').then(console.log);
connector.RepaymentApi().repayPrincipal('0xED455becbCeA559763C2a84b6C69Ff297C303A2b').then(console.log);
...
connector
  .YieldAndStrategyApi()
  .getSharesForTokens(
    '0xED455becbCeA559763C2a84b6C69Ff297C303A2b',
    '0xED455becbCeA559763C2a84b6C69Ff297C303A2b',
    '0xED455becbCeA559763C2a84b6C69Ff297C303A2b'
  )
  .then(console.log);
